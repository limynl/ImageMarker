...
public class DayRecommendFragmentCopy extends Fragment implements OnItemActionListener, SwipeRefreshLayout.OnRefreshListener{
...
//                    recyclerView.addItemDecoration(new DividerItemDecoration(getContext(),DividerItemDecoration.VERTICAL_LIST));
                    ...
                    adapter.setOnItemActionListener(DayRecommendFragmentCopy.this);
                }
                break;
            }
        }
    ...
    public static DayRecommendFragmentCopy getInstance(String title) {
        DayRecommendFragmentCopy fra = new DayRecommendFragmentCopy();
    ...
    private void getDataFromNet(){
        String url = Constants.Img_Scan_Every_Marjor_Push;
        Map<String, String> map = new HashMap<String, String>();
        map.put("userId", String.valueOf(userModel.getId()));
        VolleyRequestUtil.RequestPost(getContext(), url, "DayRecommendFragmentCopy", map, new VolleyListenerInterface() {
            @Override
            ...
            public void onError(VolleyError error) {
                Log.e("DayRecommendCopy", "onError:" + error.toString());
                getDataFromNet();
            }
        });
    }
