...
public class MultiShapeView extends View {
    ...
    public MultiShapeView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        mBorderColor = typedArray.getColor(R.styleable.MultiShapeView_border_color_one, DEFAULT_BORDER_COLOR);
        mCoverColor  = typedArray.getColor(R.styleable.MultiShapeView_cover_color, DEFAULT_COVER_COLOR);
        mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.MultiShapeView_border_width_one, DEFAULT_BORDER_WIDTH);
