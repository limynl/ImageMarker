package com.team.imagemarker.utils.chart;
...
public class SlimChart extends View {
    ...
    private void init(AttributeSet attrs){
        ...
        try {
            ...
            this.strokeWidth = (int) typedArray.getDimension(R.styleable.SlimChart_strokeWidthChart, strokeWidth * density);
            ...
            this.textColor = typedArray.getColor(R.styleable.SlimChart_textColorChart, Color.WHITE);
