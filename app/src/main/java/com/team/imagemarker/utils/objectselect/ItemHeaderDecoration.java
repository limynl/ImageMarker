...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    private List<TwoLevelBean> mDatas;
    ...
    public ItemHeaderDecoration(Context context, List<TwoLevelBean> datas) {
        super();
    ...
    public ItemHeaderDecoration setData(List<TwoLevelBean> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    public void onDrawOver(Canvas c, final RecyclerView parent, RecyclerView.State state) {
        ...
        View topTitleView = mInflater.inflate(R.layout.item_object_select_two_level_title, parent, false);
