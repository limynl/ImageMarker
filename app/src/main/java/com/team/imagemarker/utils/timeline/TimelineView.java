package com.team.imagemarker.utils.timeline;
...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mMarkerSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_markerSize, SizeUtils.dpToPx(20, mContext));
        mLineSize = typedArray.getDimensionPixelSize(R.styleable.timeline_style_lineSize, SizeUtils.dpToPx(2, mContext));
        ...
        if(mStartLine == null && mEndLine == null) {
            mStartLine = new ColorDrawable(mContext.getResources().getColor(R.color.button1));
            mEndLine = new ColorDrawable(mContext.getResources().getColor(R.color.button1));//darker_gray
        }
    }
